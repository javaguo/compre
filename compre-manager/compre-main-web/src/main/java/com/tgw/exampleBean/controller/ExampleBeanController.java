package com.tgw.exampleBean.controller;
...
import com.tgw.exampleBean.model.ExampleBean;
import com.tgw.exampleBean.service.ExampleBeanService;
...
public class ExampleBeanController extends BaseController<ExampleBean> {
    ...
    public void initField( SysEnController controller ) throws PlatformException {
        ...
        String treeUrl1=  "resource/js/platform/manage/exampleBean/tree/tree2.json";
        String treeUrl2 = "resource/js/platform/manage/exampleBean/tree/tree2.json";
...
//        String formDisplayConfigs = null;//配置为空时，则使用框架默认配置。
        ...
        controller.addJsFileName( "manage/exampleBean/fieldUserDefineOpe.js" );
    ...
    public void initFunction(SysEnController controller) throws PlatformException {
        ...
        controller.addJsFileName( "manage/exampleBean/menuUserDefineOpe.js" );
   ...
   /* @RequestMapping("/save.do")
    ...
    public ModelAndView openNewTab(HttpServletRequest request, HttpServletResponse responsen){
        ...
        modelAndView.setViewName("page/manage/exampleBean/openNewTab");
        return  modelAndView;
    }
